...
One thing I met in my vanilla Arch install is `iwctl`.
...
[041-iw-dev-conn]:  {{ asset_path }}/061-nm-disable.png
[041-iw-dev-conn]:  {{ asset_path }}/061-nm-enable.png
[041-iw-dev-conn]:  {{ asset_path }}/061-nm-user-nosudo.png
[041-iw-dev-conn]:  {{ asset_path }}/062-nm-start-stop.png
[041-iw-dev-conn]:  {{ asset_path }}/062-nm-status.png
[041-iw-dev-conn]:  {{ asset_path }}/062-nm-status-active.png
[041-iw-dev-conn]:  {{ asset_path }}/063-dhcp-disable.png
[041-iw-dev-conn]:  {{ asset_path }}/063-dhcp-enable.png
[041-iw-dev-conn]:  {{ asset_path }}/064-dhcp-start-stop.png
[041-iw-dev-conn]:  {{ asset_path }}/064-dhcp-status.png
[041-iw-dev-conn]:  {{ asset_path }}/065-nmtui-01.png
[041-iw-dev-conn]:  {{ asset_path }}/065-nmtui-02.png
[041-iw-dev-conn]:  {{ asset_path }}/065-nmtui-03.png
[041-iw-dev-conn]:  {{ asset_path }}/065-nmtui-04.png
[041-iw-dev-conn]:  {{ asset_path }}/065-nmtui-05.png
[041-iw-dev-conn]:  {{ asset_path }}/065-ping-8888.png
[041-iw-dev-conn]:  {{ asset_path }}/065-ping-archlinux.png