...
* Basic Administration: fstab, samba, git, printing, and stuff.
...
* Setting Up Application.
  POP3 Client, Python Macro, Container.
...
My life at stakes. If my computer stalled. I job would be doomed. 
...
I should even wrapped it in a plastic everytime,
because of rainy season in Indonesia,
the water could flood into my waterproof knapsack.
...
and `power10k` for zsh customization.
...
I can share `.xlsx` between my collagues.
And edit them in linux.
