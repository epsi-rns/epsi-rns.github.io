...
* 3: [Building the XPM](#xpm)

* 4: [Gradient and Highlight](#gradient-highlight)

* 5: [Button](#button)

* 6: [Gradient Theme](#gradient-theme)
...
<a name="gradient-highlight"></a>

### 4: Gradient and Highlight
